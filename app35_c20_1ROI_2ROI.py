...
video_list = [
    ...
    '/home/oasees/AV_3_6/final_combined_video4.mp4'
]
...
if use_dual_stream:
    ffmpeg_cmd = [
        ...
        '-vf', 'fps=10,scale=1280:720',   # 832:416   
        '-c:v', 'libx264',
        '-b:v', '2000k',
        '-g', '30', '-keyint_min', '30',
        '-preset', 'veryfast',
...
model = torch.hub.load('ultralytics/yolov5', 'custom',
                       path='/home/oasees/AV_3_6/Weights_yolov5_23_9_25_v14_with_183images_45epochs/best.pt', trust_repo=True, #augment=True,
                       device='cpu')
                       

#Weights_yolov5_23_9_25_v13_with_183images_45epochs
#Weights_yolov5_20_9_25_v13_45epochs
#Weights_yolov5_30_7_25_v10_45epochs/best.pt
#Weights_yolov5_15_9_25_v11_45epochs
...
model.conf = 0.20 #0.39 #0.42 #0.3 #0.25  #0.38
model.iou = 0.5
model.agnostic = True
    ...
    while True:
        ...
        if use_dual_stream and merge_toggle:
            ...
            merged = cv2.hconcat([
                ...
                cv2.resize(frame1, (800, 720)),
                cv2.resize(frame2, (540, 720))
            ])
        else:
            merged = cv2.resize(frame1, (1340, 720))  #    
        ...
        if grayscale_mode:
            ...
            resized_input = cv2.resize(merged, (1280, 720))    #   960,960 720,720  #832, 416
