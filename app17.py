...
grayscale = False  # Toggle grayscale
merge_toggle = True
...
model = torch.hub.load('ultralytics/yolov5', 'custom',
                       ...
                       device='cpu')
model.conf = 0.1           # Lower threshold to detect more
...
def gen_frames():
    ...
    while True:
        ...
        if merge_toggle:
            ...
            merged = cv2.resize(frame1, (640,720))
...
def index():
    ...
    """, mode="Grayscale" if grayscale else "Inference")
...
@app.route('/toggle-grayscale')
def toggle_grayscale():
    global grayscale
    grayscale = not grayscale
    return jsonify("Toggled grayscale filter.")
