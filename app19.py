...
merge_toggle = True
use_dual_stream = False  # Toggle single or dual stream mode
...
cap2 = cv2.VideoCapture(video_path_2) if use_dual_stream else None

if not cap1.isOpened() or (use_dual_stream and (not cap2 or not cap2.isOpened())):
